...
set(ALL_VTABLE_RANDO_SUPPORTED_ARCH ${X86} ${X86_64})
set(ALL_PLT_RANDO_SUPPORTED_ARCH ${X86} ${X86_64})
set(ALL_DATA_RANDO_SUPPORTED_ARCH ${X86} ${X86_64})
set(ALL_XCHECKS_SUPPORTED_ARCH ${X86} ${X86_64})
...
if(APPLE)
  ...
  filter_available_targets(VTABLE_RANDO_SUPPORTED_ARCH ${ALL_VTABLE_RANDO_SUPPORTED_ARCH})
  filter_available_targets(PLT_RANDO_SUPPORTED_ARCH ${ALL_PLT_RANDO_SUPPORTED_ARCH})
  filter_available_targets(DATA_RANDO_SUPPORTED_ARCH ${ALL_DATA_RANDO_SUPPORTED_ARCH})
  filter_available_targets(XCHECKS_SUPPORTED_ARCH ${ALL_XCHECKS_SUPPORTED_ARCH})
endif()
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND VTABLE_RANDO_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Linux")
  set(COMPILER_RT_HAS_VTABLE_RANDO TRUE)
else()
  set(COMPILER_RT_HAS_VTABLE_RANDO FALSE)
endif()

if (COMPILER_RT_HAS_SANITIZER_COMMON AND PLT_RANDO_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Linux")
  set(COMPILER_RT_HAS_PLT_RANDO TRUE)
else()
  set(COMPILER_RT_HAS_PLT_RANDO FALSE)
endif()

if (COMPILER_RT_HAS_SANITIZER_COMMON AND DATA_RANDO_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Linux")
  set(COMPILER_RT_HAS_DATA_RANDO TRUE)
  set(COMPILER_RT_HAS_HEAP_CHECKS TRUE)
else()
  set(COMPILER_RT_HAS_DATA_RANDO FALSE)
  set(COMPILER_RT_HAS_HEAP_CHECKS FALSE)
endif()

if (COMPILER_RT_HAS_SANITIZER_COMMON AND XCHECKS_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Linux" AND MULTICOMPILER_RAVEN_SRCDIR)
  set(COMPILER_RT_HAS_XCHECKS TRUE)
else()
  set(COMPILER_RT_HAS_XCHECKS FALSE)
endif()
